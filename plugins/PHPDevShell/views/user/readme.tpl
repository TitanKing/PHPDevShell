    ...
    <div class="row">
            ...
            <article>
                ...
                <p>
                    <a href="http://www.host1plus.com" style="padding: 3px;" class="ui-corner-all">
                        <img src="{$aurl}/plugins/PHPDevShell/images/host1plus.jpg" alt="Host1Plus" title="Host1Plus">
                    </a>
                </p>
                <p>
                    Allot of work goes into a project like this, I ask nothing in return, however,
        ...
        <div class="span6">
            <article>
                ...
                <p>
                    <label for="text">{_e('Text Field')}</label>
                    <input id="text" type="text" size="20" name="text" value="" title="{_e('Sample Text Title.')}">
                </p>
                <p>
                    <label for="textreq">{_e('Text Field Required')}</label>
                    <input id="textreq" type="text" size="20" name="textreq" value="" required="required" title="{_e('Sample Required Text Title.')}">
                </p>
                <p>
